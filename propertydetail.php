                ...
                <div class="row"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="property-details">
                            ...
                            <h4 class="text-secondary my-4">DESRICPTION</h4>
                            <p><?php echo $row['2'];?></p>
                            ...
                            <h5 class="mt-5 mb-4 text-secondary double-down-line-left position-relative">CONTACT AGENTS</h5>
                    ...
                    <div class="col-lg-4">
                        ...
                        <form method="post" action="#">
                            <div class="row">
								...
								<div class="col-md-12">
                                    <div class="form-group">
										<textarea class="form-control" placeholder="ENTER YOUR MESSAGES"></textarea>
                                    </div>
                                </div>
                        ...
                        <form class="d-inline-block w-100" action="calc.php" method="post">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="month" placeholder="DURTION MONTH">
                            </div>
                            <label class="sr-only">INTREST RATE</label>
                            <div class="input-group mb-2 mr-sm-2">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">%</div>
                                </div>
                                <input type="text" class="form-control" name="interest" placeholder="INTREST RATE">
                            </div>
