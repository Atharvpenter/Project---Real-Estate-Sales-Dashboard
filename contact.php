                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">SANGAMNER, AHILYANAGR, MAHARASTRA,422605</span> <br>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">CALL US</h5>
                                        <span class="d-table text-white">+91 7083534353</span>
										<span class="text-white">+91 7385709106</span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
										...
										<span class="text-white">help@realestatest.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
							...
							<div class="col-md-12">
								<form class="w-100" action="#" method="post">
									<div class="row">
										...
										<button type="submit" value="send message" name="send" class="btn btn-success">SEND MESSAGES</button>
									</div>
								</form>
							</div>
						</div>
