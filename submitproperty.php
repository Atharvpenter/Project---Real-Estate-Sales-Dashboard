...
if(isset($_POST['add']))
{
	...
	if($result)
		...
		{
			$error="<p class='alert alert-warning'>PROPERTY NOT INSERTED SUCCESSFULLY</p>";
		}
}							
?>
<!DOCTYPE html>
                        ...
                        <form method="post" enctype="multipart/form-data">
								<div class="description">
									...
									<?php echo $msg; ?>
										...
										<h5 class="text-secondary">PRICE AND LOCATION</h5><hr>
										<div class="row">
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="floor">
															...
															<option value="5th Floor">17th Floor</option>
															<option value="5th Floor">18th Floor</option>
															<option value="5th Floor">19th Floor</option>
															<option value="5th Floor">20th Floor</option>
															<option value="5th Floor">21th Floor</option>
														</select>
													</div>
												</div>
												<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="totalfl">
															...
															<option value="15 Floor">16 Floor</option>
															<option value="15 Floor">17 Floor</option>
															<option value="15 Floor">18 Floor</option>
															<option value="15 Floor">19 Floor</option>
															<option value="15 Floor">20 Floor</option>
															<option value="15 Floor">21 Floor</option>
														</select>
													</div>
												</div>
												<div class="form-group row">
